<h1><p align="left">
  <img src="https://github.com/timpyrkov/webappcontrols/blob/master/public/icons/apple-touch-icon.png?raw=true" alt="Web App Controls logo" height="30" style="vertical-align: middle; margin-right: 10px;">
...
![Dashboard preview](https://github.com/timpyrkov/webappcontrols/blob/master/img/dashboard.jpg?raw=true)
